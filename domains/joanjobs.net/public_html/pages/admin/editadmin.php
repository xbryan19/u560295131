...
<div class="container">
		<div class="row justify-content-center">
    	   ...
    	   <div class="col-lg-6">
		      <h5 class="page-header mt-5">Edit Details</h5>
			  <p>Please fill-up the following details</p>
							<form   method="post" action="updateadmin.php" name="register-form" id="register-form" >
			                ...
			                <div class="form-group">
							  ...
							  <input type="submit" onclick="return validation();" value="Update Admin" class="btn btn-success btn-block mb-5" name="btnregister" id="btnregister">
                          </form>		
