...
<div class="container">
		<div class="row justify-content-center">
	       			  ...
	       			  <div class="col-lg-4">
			  <h3 class="mt-5"><span class="w3-xlarge">Clients </h3>
			  <ul class="list-group">
			  <?php 
    	   ...
    	   <div class="col-lg-6">  <h1 class="w3-xxxlarge w3-text-black"><b>Chat</b></h1>
		   <h5>Client: <?php 
                if(isset($_GET["email"])){
      ...
      <div class="msg">
          <form method="post" id="msenger" action="">
           ...
           <input onclick="<?php 
			...
			<i class="fa fa-paperclip btn btn-success align-top mt-2"></i><span class="name">No file selected</span>
