  ...
  <div class="w3-container">
   ...
   <?php
      ...
      { 
       ...
       <h4>( As Applicant )</h4> <p><span class="w3-small">Current Date Time :
        <?php
       ...
       $src="./uploads/profile/".$row['avatar'];
        ...
        <img class="img-thumbnail" width="70%" height="300" src="<?php echo $src ?>" >
  ...
  <div class="w3-bar-block">
    <a href="home.php" onclick="w3_close()" class="w3-bar-item w3-button w3-padding w3-text-teal"><i class="  fa fa-home fa-fw w3-margin-right"></i>Home</a>
        <a href="myprofile.php" onclick="w3_close()" class="w3-bar-item w3-button w3-padding "><i class="fa fa-user-circle-o fa-fw w3-margin-right"></i>Profile</a>
         <a href="notification.php" onclick="w3_close()" class="w3-bar-item w3-button w3-padding "><i class="fa fa-circle-o fa-fw w3-margin-right"></i>notification
<?php   
   $result = $db->prepare("SELECT * FROM jobcontracts WHERE accountid= :userid and mark=''    ");
      ...
      <i style="color: red;"><?php echo $foundrows; ?></i>
        ...
        <a href="employers.php" onclick="w3_close()" class="w3-bar-item w3-button w3-padding "><i class="fa fa-th-large fa-fw w3-margin-right"></i>Clients</a> 
   
    <a href="jobs.php" onclick="w3_close()" class="w3-bar-item w3-button w3-padding"><i class="fa fa-shopping-bag fa-fw w3-margin-right"></i>Job List</a>
