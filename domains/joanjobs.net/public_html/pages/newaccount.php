		...
		<div class="row justify-content-center">
    	   ...
    	   <div class="col-lg-6">
			  ...
			  <p>Please fill-up the following details</p>
							<form   method="post" action="email_auth.php" name="register-form" id="register-form" >
                ...
                <option >Widow</option>
                           ...
                           <div class="form-group">
                              ...
                              <select class="form-control" id="role" name="role">
                                        ...
                                        <option>Outdoor instructor</option>
                                        <option>Transport worker</option>
                ...
                <option >College Graduate</option>
                             ...
                             <span class="help-block"></span>
                              ...
                              <div class="form-group">
                                  <label for="question" class="control-label">Secret Question</label>
...
function validation(){
	...
	if(pwd==vpwd){
	    error=0; $("#errorpwd").addClass("d-none").removeClass("d-block");
