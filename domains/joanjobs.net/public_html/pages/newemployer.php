...
<div class="container">
		<div class="row justify-content-center">
    	   ...
    	   <div class="col-lg-6">
		      <h3 class="page-header mt-5">New Client</h3>
			  <p>Please fill-up the following details</p>
							<form   method="post" action="employer_auth.php" name="register-form" id="register-form" >
   ...
   <div class="form-group">
      ...
      <div class="form-group">
                ...
                <option >Widow</option>
                              ...
                              <div class="form-group">
                                  <label for="civil" class="control-label">Secret Question</label>
