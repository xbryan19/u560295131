...
if(password_verify($code, $_SESSION['hash'])) {
    ...
    $query = "INSERT INTO jobseekers (email,lname,fname,mname,gender,address,birthday,contact,password,education,civil,role) VALUES (:a,:b,:c,:d,:e,:f,:g,:h,:i,:j,:k,:l)";
    ...
    $sql->bindParam(':l', $_SESSION['role'], PDO::PARAM_STR);    
	$sql->execute();
	
	/* secret_account parameter*/
	$sa = "INSERT INTO secret_applicant (question,answer,email) VALUES (:que,:ans,:em)";
	$sql1 = $db->prepare($sa);
